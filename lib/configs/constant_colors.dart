...
import '../utils/extensions/color_extenstion.dart';

// New Design System Colors
final Color kPrimaryBackground = '#121212'.toColor();
final Color kPrimaryText = '#FFFFFF'.toColor();
final Color kSecondaryText = '#A0A0A0'.toColor();
final Color kAccentColor = '#007BFF'.toColor();
final Color kSurfaceColor = '#1E1E1E'.toColor();
final Color kChipBackground = '#333333'.toColor();
...
// Old Colors (To be reviewed and removed)
